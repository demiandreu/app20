...
async function initDb() {
  ...
  // Eliminar índice problemático si existe (por si quedó corrupto)
  await pool.query(`DROP INDEX IF EXISTS idx_apartment_sections_apartment;`);
  
  // Recrear índice para apartment_sections
  await pool.query(`CREATE INDEX idx_apartment_sections_apartment ON apartment_sections(apartment_id);`);
